...
int main()
{
    ...
    for (auto &value : my_vec) //read and write
    {
        std::cout << value << '\n';
    }
    ...
    auto my_vec2 = std::vector<std::int32_t>(3, 0); // init 3 elements with value 0
    std::cout << "\nZero init 3 Elements: Loop:\n";
    ...
    my_vec3.pop_back();
    std::cout << "\nRemoved the last element of the vector:\n";
    for (const auto value : my_vec3) //read only
    {
        std::cout << value << '\n';
    }
